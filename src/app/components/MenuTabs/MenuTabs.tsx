...
const menuContent = {
    "tab-1": [
        ...
        { name: "Puri Bhaji", price: "₹100", desc: "Deep-fried puris served with spiced potato curry." },
        ...
        { name: "Paneer Paratha", price: "₹100", desc: "Stuffed flatbread filled with grated paneer and spices." },
    ...
    "tab-2": [
        ...
        { name: "Egg Maggi (2 packs)", price: "₹120", desc: "Masala noodles cooked with scrambled eggs." },
    ],
    "tab-3": [
    ...
    "tab-5": [
        ...
        { name: "Raita", price: "₹60", desc: "Curd mixed with cucumber or boondi and mild spices." },
        { name: "Green Salad", price: "₹80", desc: "Fresh seasonal salad with cucumber, tomato, and onion." },
        { name: "Pav (2 nos)", price: "₹20", desc: "Soft and fluffy Indian bread rolls." },
        { name: "Bread (4 slices)", price: "₹20", desc: "Plain toasted bread slices." },
        { name: "Curd", price: "₹40", desc: "Fresh homemade yogurt." },
    ],
    "tab-6": [
        { name: "Veg Barbeque (1/2 kg Paneer)", price: "₹600", desc: "Grilled paneer cubes marinated in smoky spices." },
        { name: "Chicken Barbeque (1/2 kg)", price: "₹600", desc: "Juicy chicken pieces grilled with spicy marinade." },
    ],
    "tab-7": [
        ...
        { name: "Sabji (as per availability)", price: "₹170", desc: "Daily special vegetable curry prepared Indian style." },
    ...
    "tab-8": [
        ...
        { name: "Chicken Hakka Noodles", price: "₹140", desc: "Stir-fried noodles with vegetables and shredded chicken." },
        { name: "Chicken Handi (1/2 kg)", price: "₹400", desc: "Creamy chicken curry cooked in handi style." },
        { name: "Chicken Handi (1 kg)", price: "₹750", desc: "Full portion of rich handi-style chicken curry." },
        { name: "Chicken Malwani (1/2 kg)", price: "₹450", desc: "Spicy coconut-based Malwani chicken curry." },
        { name: "Chicken Malwani (1 kg)", price: "₹800", desc: "Authentic Malwani-style chicken curry in large portion." },
        { name: "Chicken Kolhapuri (1/2 kg)", price: "₹450", desc: "Hot and spicy chicken curry from Kolhapur." },
        { name: "Chicken Kolhapuri (1 kg)", price: "₹800", desc: "Large portion of fiery Kolhapuri chicken curry." },
        { name: "Mutton Handi (1/2 kg)", price: "₹800", desc: "Slow-cooked mutton curry with rich spices." },
        { name: "Mutton Handi (1 kg)", price: "₹1400", desc: "Large portion of rich handi-style mutton curry." },
        { name: "Mutton Sukha (1/2 kg)", price: "₹800", desc: "Dry-style mutton preparation with roasted spices." },
    ...
    "tab-9": [
        ...
        { name: "Veg Fried Rice", price: "₹180", desc: "Fried rice with assorted vegetables and soy flavor." },
        { name: "Chicken Fried Rice", price: "₹200", desc: "Fried rice tossed with chicken and sauces." },
        ...
        { name: "Egg Biryani (1/2 kg)", price: "₹500", desc: "Basmati rice layered with egg masala and spices." },
        { name: "Egg Biryani (1 kg)", price: "₹900", desc: "Full portion of aromatic egg biryani." },
        { name: "Chicken Biryani (1/2 kg)", price: "₹600", desc: "Spiced chicken biryani with basmati rice." },
        { name: "Chicken Biryani (1 kg)", price: "₹1100", desc: "Classic chicken biryani served in full portion." },
        { name: "Mutton Biryani (1/2 kg)", price: "₹800", desc: "Half portion of flavorful mutton biryani." },
        { name: "Mutton Biryani (1 kg)", price: "₹1600", desc: "Full portion of rich and aromatic mutton biryani." },
    ],
    "tab-10": [
        ...
        { name: "Chicken 65 (250g)", price: "₹210", desc: "Crispy spicy deep-fried chicken pieces." },
        { name: "Chicken Chilly (250g)", price: "₹230", desc: "Chicken tossed with onions, peppers, and sauces." },
